...
public class PostingDaoSqls {
    public static final String INSERT_ARTICLE_WITH_POSTING_DATA = "INSERT INTO article (date,nickname,article,photo,tag,latitude,longitude,building) VALUES (:date,:nickname,:article,:photo,:tag,:latitude,:longitude,:building)";
